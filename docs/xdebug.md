...
2. Create a new server:
   * Name: `catalog` (or whatever you want to use for the variable `PHP_IDE_CONFIG`)
   * Host: `catalog.neuron.localhost` (or the one defined using the `SERVER_NAME` environment variable)
   * Port: `80`
   * Debugger: `Xdebug`
